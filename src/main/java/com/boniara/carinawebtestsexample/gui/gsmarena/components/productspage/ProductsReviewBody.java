package com.boniara.carinawebtestsexample.gui.gsmarena.components.productspage;
...
public class ProductsReviewBody extends AbstractUIObject {
    ...
    private ProductItem getProductItemByName(String productItemName) {
        ...
        throw new ProductNotFoundException("Product with name '" + productItemName + "' is not found");
    }
}
